                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                      <form action="{{ route('admin.update-general-setting') }}" method="POST" enctype="multipart/form-data">
                                                          ...
                                                          <div class="form-group">
                                                              <label for=""> Goole Map Location </label>
                                                              <input type="text" value="{{ $setting->google_location }}" class="form-control" name="google_location">
                                                          </div>
                                                          
                                                           <div class="form-group">
                                                              <label for=""> Goole Map Location (footer) </label>
                                                              <input type="text" value="{{ $setting->footer_google_location }}" class="form-control" name="footer_google_location">
                                                          </div>
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('user.update-facebook-pixel') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Facebook App Id')}}</label>
                                                                <textarea cols="80" row="60" name="app_id">{{ $facebookPixel->app_id }}</textarea>
