        ...
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <span class="text-muted">{{$order_inv->total_amount}}</span>
                </li>
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="customer_name" class="form-control" id="customer_name" placeholder=""
                               value="{{$order_inv->orderAddress->billing_name}}" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="customer_mobile" class="form-control" id="mobile" placeholder="Mobile"
                               value="{{$order_inv->orderAddress->billing_phone}}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="customer_email" class="form-control" id="email"
                           placeholder="you@example.com" value="{{$order_inv->orderAddress->billing_email}}" required>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="1234 Main St"
                          name="address" value="{{$order_inv->orderAddress->billing_address}}" required>
                    <div class="invalid-feedback">
